...
const Footer = () => {
  return (
    <>
      ...
      <footer className="footer bg-blue-500 text-base-content border-base-300 border-t px-10 py-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            ...
            <div>
              ...
              <p className="mt-4 text-start">
                ELITE PROPERTY is a platform offering anyone the ability to
                invest and potentially earn money from property at the click of
                a button
              </p>
