            ...
            >
              <DialogPanel className="w-full max-w-lg transform overflow-hidden rounded-3xl bg-white p-8 text-left align-middle shadow-2xl transition-all">
                ...
                <div className="mt-8 flex justify-center gap-4">
                  <button
                    type="button"
                    className="px-6 py-2.5 bg-red-600 text-white font-medium text-sm rounded-full shadow-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                    onClick={() => setIsEditModalOpen(false)}
                  >
                    Cancel
                  </button>
